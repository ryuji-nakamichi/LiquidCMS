              ...
              <div class="g-contact-contents">
                <div>
                  ...
                  <div class="g-contact-frame">
                    <?php require_once(INCLUDE_BLOCK_PATH . 'contents/group/result.php'); ?>
                  </div>
                  <div class="g-contact-frame">
                    <?php require_once(INCLUDE_BLOCK_PATH . 'contents/group/head.php'); ?>
                    <div class="g-contact-form-container">
                      <form id="g-contact-form" class="g-contact-form" method="post">
                        <div class="g-contact-form-contents">
                          <?php require_once(INCLUDE_BLOCK_PATH . 'contents/group/input.php'); ?>
                        </div>
                      </form>
                    </div>
                  </div>
