                          ...
                          <li class="list__item">
                            <p class="item__des">
                              ...
                              <span id="result-name" class="item__des-inner">
                                {{ formData.posts.name !== '' ? formData.posts.name : '入力なし' }}
                              </span>
                            </p>
                          </li>
                          <li class="list__item">
                            <p class="item__des">
                              ...
                              <span id="result-category" class="item__des-inner">{{ formData.posts.category !== '' ? formData.posts.category : '選択なし' }}</span>
                            </p>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div class="g-contact-form-contents">
                        ...
                        <div class="c-switch-contents --step-1" data-step="1" v-if="currentStep === 1">
                          <div class="g-contact-form-blk --name">
                            ...
                            <div class="form-blk-input">
                              <input id="name" class="name form-blk-input-field js-post-field" type="text" name="name" v-model="formData.posts.name" @input="getContentsName(); checkContentsName();" data-type="text">
                              <p class="form-blk-input-err"></p>
                            </div>
                            <div class="form-blk-input --err" v-if="!errData.posts.name">
                              ...
                              <div class="form-blk-input">
                                <div class="c-submit-btn-outer --col-1">
                                  <div class="c-submit-btn-container">
                                    <button id="g-form-input" class="c-submit-btn" type="button" data-mode="next" @click="changeNextStep()" v-if="errData.posts.name">
                        ...
                        <div class="c-switch-contents --step-2" data-step="2" v-if="currentStep === 2">
                          <div class="g-contact-form-blk --category">
                            ...
                            <div class="form-blk-input --err" v-if="!errData.posts.category">
                            ...
                            <div class="form-blk-input">
                              <div class="form-blk-input">
                                <div class="c-submit-btn-outer">
                                  ...
                                  <div class="c-submit-btn-container">
                                    <button id="g-form-confirm" class="c-submit-btn" type="button" data-mode="next" @click="changeNextStep()" v-if="errData.posts.category">
                            ...
                            <div class="form-blk-input">
                              <div class="form-blk-input">
                                <div class="c-submit-btn-outer">
                                  ...
                                  <div class="c-submit-btn-container">
                                    <button id="g-form-submit" class="c-submit-btn" type="button" data-mode="submit" @click="changeNextStep()">
